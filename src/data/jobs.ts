...
export const JOBS: Job[] = [
  ...
  },
  {
    ...
    minigame: {
      ...
      kunder: [
        ...
        { text: 'Jag behöver en träklubba att slå ut med.', svar: 'driver', nastan: ['hybridklubba', 'jarnklubba', 'putter'], fel: 'Det där är inget trä. Det är ju inte trä heller, men ändå.' },
        ...
        { text: 'Jag hamnar i sanden hela tiden. Vad ska jag ta upp därifrån med?', svar: 'wedge', nastan: ['putter', 'driver', 'bunker'], fel: 'Jag sa UPP ur sanden, inte längre ner.' },
        { text: 'Bollen ligger alltid i den där. Vad kallas den?', svar: 'bunker', nastan: ['green', 'range', 'wedge'], fel: 'Nej, DÄR hamnar jag aldrig. Tyvärr.' },
        ...
        { text: 'Jag behöver en ny. Vit. Liten. Med gropar.', svar: 'golfboll', nastan: ['peg', 'golfhandske', 'headcover'], fel: 'Gropar, sa jag. GROPAR.' },
      ],
    },
    scene:
  ...
  },
  {
    ...
    minigame: {
      ...
      kunder: [
        { text: 'Något bubbligt till skålen, tack.', svar: 'champagne', nastan: ['vitvin', 'rosevin', 'ishink'], fel: 'Det där bubblar inte. Jag har tittat noga.' },
        ...
        { text: 'Var ligger vinet och blir gammalt och dyrt?', svar: 'ekfat', nastan: ['vinkallare', 'ishink', 'dekanter'], fel: 'Ligger det där? I det? Nej.' },
  ...
  },
  {
    ...
    minigame: {
      kind: 'traffa',
      title: 'Plocka bollarna',
      brief: 'Plocka bollarna mellan poängen – men rör inte det som ligger kvar på banan.',
      items: ['Tennisboll', 'Boll vid nätet', 'Boll i hörnet', 'Boll vid stolen'],
      avoid: ['Domarens flaska', 'Handduken', 'Racketen', 'Linjedomaren'],
    },
  ...
  },
  {
    ...
    minigame: {
      kind: 'traffa',
      title: 'Städa stranden',
      brief: 'Plocka skräpet på stranden och låt allt som lever vara.',
      items: ['Plastflaska', 'Glassomslag', 'Kapsyl', 'Plastpåse'],
      avoid: ['Krabban', 'Sjöstjärnan', 'Snäckan', 'Maneten'],
    },
  ...
  },
  {
    ...
    minigame: {
      kind: 'vaxel',
      title: 'Kassan i uthyrningen',
      brief: 'Kunden betalar och ska ha rätt växel tillbaka. Räkna i huvudet, kön är lång.',
      items: ['Dagshyra', 'Hjälm', 'Lås', 'Barnsadel', 'Timhyra'],
    },
