...
export const UPPDRAG: Uppdrag[] = [
  ...
  { id: 'paraply', titel: 'Paraplyet', text: 'Jag lånade det här paraplyet av en främling i {stad} för elva år sedan. Hon sa "lämna tillbaka det när du kan". Jag kan nu. Hon står i tobaksaffären vid torget. {belopp}, och min nattsömn.', foremal: 'Ett paraply, lånat 2015', belopp: 2200, klar: 'Kvinnan i tobaksaffären tittar på paraplyet. "Det där är inte mitt." Ni tittar på varandra. Hon tar det ändå. Du får pengarna av dig själv, i förskott, av uppdragsgivaren.' },
  ...
  { id: 'sten', titel: 'Stenen', text: 'Jag tog den här stenen från stranden i {stad} som barn. Nu drömmer jag om den varje natt. Lägg tillbaka den. Det spelar ingen roll var på stranden, men det ska vara samma strand. {belopp}.', foremal: 'En sten som ska hem', belopp: 2900, klar: 'Du lägger stenen på stranden i {stad}. Den ser ut som de andra stenarna. Det är nog tanken. Kvällen efter sover en människa gott, på annat håll.' },
  { id: 'svar', titel: 'Svaret', text: 'En man i {stad} ställde en fråga till mig 1998. Jag har svaret nu. Det är "ja". Säg det till honom. Han heter Bertil och driver kiosken vid hamnen. {belopp}. Säg inget mer än ja.', foremal: 'Ett ja, till Bertil', belopp: 3300, klar: 'Bertil hör ordet, stänger kiosken mitt på dagen och går hem. Du får pengarna av den som skickade dig. Vad frågan var får du aldrig veta.' },
];
