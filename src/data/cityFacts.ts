...
export const CITY_FACTS: Record<string, string[]> = {
  ...
  belgrad: [
    ...
    'Nikola Tesla-museet i staden förvarar hans aska i en förgylld sfär. Museet ligger i en villa från 1929 och besökarna får hålla i lysrör som tänds av sig själva.',
  ...
  hudiksvall: [
    ...
    'Sju hälsingegårdar utanför staden står på Unescos världsarvslista sedan 2012. Bönderna målade festvåningar de knappt använde, för att visa vad linet och skogen gett.',
  ...
  brescia: [
    ...
    'Mille Miglia startade här 1927: ett landsvägslopp på tusen italienska mil, Brescia–Rom–Brescia. Loppet körs numera som rally för veteranbilar, med start på Viale Venezia.',
    'Franciacorta söder om staden gör mousserande vin med andrajäsning i flaskan, samma metod som i Champagne. Namnet får bara användas inom området.',
    ...
    'Piazza della Loggia har ett astronomiskt ur från 1546 som visar månfaser och stjärntecken. Två bronsfigurer slår i klockan, och de kallas i folkmun för mackarna.',
  ...
  sansebastian: [
    ...
    'Staden har bland världens högsta antal Michelinstjärnor per invånare. Tre av krogarna har tre stjärnor, i en stad med knappt 190 000 invånare.',
    'Pintxos är baskiska snittar som ställs fram på disken i barerna. Man äter en, betalar, går vidare till nästa bar, och räknar pinnarna på slutet.',
  ...
  oaxaca: [
    ...
    'Delstaten har sexton erkända urfolksgrupper och lika många språkfamiljer. Zapotekiska och mixtekiska talas fortfarande dagligen på marknaderna.',
    ...
    'De allhelgonafirandet som kallas Día de Muertos hålls i månadsskiftet oktober–november, med altare i hemmen och nattvak på kyrkogårdarna.',
  ],
};
