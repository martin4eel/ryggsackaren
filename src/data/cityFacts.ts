...
export const CITY_FACTS: Record<string, string[]> = {
  ...
  belgrad: [
    'Belgrad ligger där Sava rinner ut i Donau. Fästningen Kalemegdan står på udden mellan floderna och har haft romerska, bysantinska, ungerska, osmanska och österrikiska garnisoner.',
    'Staden har förstörts och byggts upp igen ett fyrtiotal gånger. Det är därför gatunätet växlar mellan osmanska gränder, wienerklassicism och betong från femtiotalet inom loppet av ett kvarter.',
    'Skadarlija är stadens bohemkvarter sedan 1800-talet, med kullersten och restauranger som kallas kafanas. Där spelas levande musik varje kväll och räkningen kommer när gästen frågar, inte förr.',
    'Splavovi är flytande klubbar förtöjda längs Sava och Donau. De flyttas när isen kommer och tillbaka när den släpper, vilket gör Belgrads nattliv till en säsongsfråga.',
    'Vinča utanför staden var en av Europas största bosättningar för sjutusen år sedan. Fynden därifrån gav namn åt hela Vinčakulturen.',
    'Nikola Tesla-museet i staden förvarar hans aska i en förgylld sfär. Museet ligger i en villa från 1927 och besökarna får hålla i lysrör som tänds av sig själva.',
    'Serbien använder dinar, och växelkontoren står tätt. Många priser anges ändå i euro, särskilt när någon vill sälja något dyrt.',
  ],
  hudiksvall: [
    'Hudiksvall fick stadsprivilegier 1582 av Johan III och är Hälsinglands äldsta stad. Ryssarna brände den 1721, vilket ortsborna fortfarande tar upp.',
    'Möljen är raden av rödmålade fiskebodar och sjöbodar vid kanalen mitt i staden. Bodarna är från 1700- och 1800-talen och ligger kvar där handeln en gång låg.',
    'Sju hälsingegårdar i landskapet står på Unescos världsarvslista sedan 2012. Den närmaste ligger sex mil bort. Bönderna målade festvåningar de knappt använde, för att visa vad linet och skogen gett.',
    'Uttrycket Glada Hudik kommer från 1800-talet, då stadens borgare ansågs festa mer än ekonomin tålde. Teatergruppen med samma namn har spelat sedan 1996.',
    'Hornslandet öster om staden är en halvö med klapperstensfält och fiskelägen. Landet stiger fortfarande knappt en centimeter om året efter inlandsisen.',
    'Linet var Hälsinglands ekonomi i århundraden. Ännu på 1800-talet vävdes linnedukar i nästan varje gård, och tullen i Hudiksvall räknade balarna.',
  ],
  brescia: [
  ...
  sansebastian: [
    ...
    'Staden har bland världens högsta antal Michelinstjärnor per invånare. Tre trestjärniga krogar ligger i staden eller strax utanför, i ett område med knappt 190 000 invånare.',
    'Pintxos är baskiska snittar som ställs fram på disken i barerna. Man tar en, bartendern räknar pinnarna när man betalar, och sedan går man vidare till nästa bar.',
    'Filmfestivalen Zinemaldia har hållits sedan 1953 och är en av Europas äldsta. Guldsnäckan är dess huvudpris, uppkallad efter bukten.',
    'Staden brann ner 1813 när brittiska och portugisiska trupper intog den under Napoleonkrigen. Den byggdes upp igen efter en rutplan, och 31 augusti hålls minnesdag med levande ljus.',
    'Vågorna vid Zurriolastranden gör staden till ett surfcentrum, medan La Concha är skyddad av ön Santa Clara och nästan alltid spegelblank.',
  ],
  oaxaca: [
    'Oaxaca de Juárez ligger 1 550 meter över havet i en dal mellan Sierra Madre-kedjorna. Stadskärnan står på Unescos världsarvslista tillsammans med Monte Albán.',
    'Monte Albán byggdes av zapotekerna från omkring 500 f.Kr. på ett utjämnat bergskrön ovanför dalen. Där finns ett bollplan, gravar och stenreliefer som kallas los danzantes.',
    'Delstaten har sexton erkända urfolksgrupper och lika många språk, de flesta i den oto-mangueiska familjen. Zapotekiska och mixtekiska talas fortfarande dagligen på marknaderna.',
    'Mole är regionens signaturrätt, och Oaxaca räknar sju varianter: negro, rojo, amarillo, verde, coloradito, chichilo och manchamanteles. Den svarta tar längst tid.',
    'Mezcal destilleras av agave som rostats i jordugn, vilket ger röksmaken. Tequila är en mezcal av bara blå agave, men det säger man inte högt i Oaxaca.',
    'I Teotitlán del Valle vävs mattor på trampvävstolar som spanjorerna införde på 1500-talet, med färger ur indigo, kochenill och lav.',
    'Det allhelgonafirande som kallas Día de Muertos hålls i månadsskiftet oktober–november, med altare i hemmen och nattvak på kyrkogårdarna.',
  ],
  alicante: [
    'Alicante ligger vid Costa Blanca i den valencianska regionen. Både spanska och valencianska är officiella språk, och på valencianska heter staden Alacant.',
    'Castell de Santa Bárbara står på kalkberget Benacantil, 166 meter rakt ovanför hamnen. Det första fästet på klippan byggdes under muslimskt styre på 800-talet.',
    'Explanada de España är lagd med omkring 6,6 miljoner marmorplattor i rött, svart och benvitt. Mönstret är vågor, och det syns bäst uppifrån borgen.',
    'Under Hogueras de San Juan reses stora skulpturer på torgen och bränns på Johannesnatten den 24 juni. En figur benådas varje år och flyttas till stadens museum.',
    'Turrón, nougaten av mandel och honung, kommer från Jijona några mil inåt land och äts framför allt till jul.',
    'Ön Tabarca utanför hamnen är Spaniens minsta bebodda ö. Vattnen runt den är marint reservat, och fisket där är reglerat.',
    'Palmlunden i grannstaden Elche är Europas största, med mellan 200 000 och 300 000 palmer, och står på Unescos världsarvslista.',
  ],
  montgomery: [
    'Montgomery är Alabamas huvudstad och ligger vid Alabamafloden. Delstatskapitoliet står på en kulle i änden av Dexter Avenue.',
    'Den 1 december 1955 vägrade Rosa Parks lämna sin plats på bussen. Bussbojkotten som följde varade i 381 dagar och slutade i december 1956.',
    'Martin Luther King var pastor i Dexter Avenue Baptist Church 1954–1960. Kyrkan ligger ett kvarter från kapitoliet, och det var i dess källare bojkotten organiserades.',
    'Staden var Amerikas konfedererade staters första huvudstad 1861, innan regeringen flyttade till Richmond. Jefferson Davis svors in på kapitoliets trappa den 18 februari samma år.',
    'Marscherna från Selma till Montgomery i mars 1965 slutade framför kapitoliet. Sträckan är drygt åtta mil och tog fem dagar att gå.',
    'Hank Williams växte upp i Alabama och ligger begravd i Montgomery. Han dog 1953, tjugonio år gammal.',
    'Equal Justice Initiative öppnade 2018 Legacy Museum och National Memorial for Peace and Justice, minnesmärket över lynchningens offer.',
    'Bröderna Wright öppnade sin första civila flygskola här 1910, på fältet som senare blev Maxwell Air Force Base.',
  ],
  visby: [
    'Visby ligger på Gotland, Sveriges största ö, och har omkring 25 000 invånare. Färjan går från Nynäshamn och Oskarshamn; någon järnväg finns inte längre på ön.',
    'Ringmuren är 3,4 kilometer lång och restes på 1200-talet. Av de 29 marktornen står 27 kvar, och därtill nio av de mindre sadeltornen.',
    'Staden blev världsarv 1995, under namnet Hansestaden Visby. Motiveringen pekar på muren och på de många kyrkoruinerna.',
    'Av medeltidens kyrkor är Sankta Maria domkyrka den enda som fortfarande används. Resten står som ruiner mitt inne i staden.',
    'Den danske kungen Valdemar Atterdag erövrade Gotland 1361. Bönderna som mötte honom utanför muren stupade i ett slag vars massgravar grävdes ut på 1900-talet.',
    'Medeltidsveckan hålls i augusti och Almedalsveckan i juli. Den senare räknar sin början till 1968, när Olof Palme talade från ett lastbilsflak i Almedalen.',
    'Spillingsskatten, den största kända silverskatten från vikingatiden, hittades på norra Gotland 1999 och väger omkring 67 kilo.',
    'Saffranspannkaka med salmbärssylt och grädde är öns efterrätt. Filmerna om Pippi Långstrump spelades in i och kring Visby i slutet av sextiotalet.',
  ],
  kingston: [
    'Kingston grundades 1692, sedan en jordbävning sänkt större delen av sjörövarstaden Port Royal på andra sidan hamnen.',
    'Stadens naturliga hamn är en av världens största, och det var den som gjorde Kingston till Jamaicas viktigaste stad.',
    'Bob Marley bodde och spelade in på Hope Road 56. Huset är museum sedan 1986, och kulhålen efter attentatet mot honom 1976 sitter kvar i väggen.',
    'Ska, rocksteady och reggae växte fram i Kingston på sextiotalet, i kvarter som Trench Town. Reggae fördes upp på Unescos lista över immateriellt kulturarv 2018.',
    'Blue Mountains reser sig öster om staden. Blue Mountain Peak är 2 256 meter och landets högsta punkt, och kaffet från sluttningarna säljs under bergets namn.',
    'Jamaica blev självständigt från Storbritannien den 6 augusti 1962. Flaggan är svart, grön och gul och saknar både rött, vitt och blått.',
    'Engelska är officiellt språk, men i vardagen talas jamaicansk patois. Nationalrätten är ackee med saltfisk, och ackee är också nationalfrukt.',
    'Devon House byggdes 1881 åt George Stiebel, Jamaicas förste svarte miljonär. I dag är huset mest känt för sin glass.',
  ],
  chicago: [
    'Chicago ligger vid Lake Michigan i delstaten Illinois och är USA:s tredje största stad.',
    'Den stora branden i oktober 1871 lade större delen av staden i aska. Återuppbyggnaden gjorde Chicago till platsen där skyskrapan uppfanns.',
    'Home Insurance Building, färdigt 1885, brukar räknas som världens första skyskrapa: tio våningar burna av en stomme i stål i stället för av murade väggar.',
    'Willis Tower, länge kallat Sears Tower, stod klart 1973. Det är 442 meter till taket och var världens högsta hus i nästan tjugofem år.',
